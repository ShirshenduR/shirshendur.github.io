...
export function Navbar() {
  ...
  return (
    <nav style={{
      ...
      background: scrolled ? "rgba(12,12,15,0.95)" : "rgba(12,12,15,0.7)",
      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "0 24px", height: "100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        {/* Brand — clicking goes home (terminal) */}
        <button
          onClick={() => navigate("/")}
        ...
        >
          ...
          <span style={{ color: "var(--muted)", fontSize: 13, fontFamily: "inherit" }}>@portfolio:~%</span>
        </button>
